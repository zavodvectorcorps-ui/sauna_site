    ...
    <AnimatePresence>
      ...
      >
        <div className="relative">
          {pulse && (
            <div className="absolute inset-0 bg-[#25D366] rounded-[14px] animate-ping opacity-25" />
          )}
          <div className="relative w-[52px] h-[52px] bg-[#25D366] rounded-[14px] flex items-center justify-center shadow-xl group-hover:bg-[#1fba57] transition-all duration-300 group-hover:scale-105">
