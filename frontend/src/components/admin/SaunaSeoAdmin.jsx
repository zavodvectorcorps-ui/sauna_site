      ...
      <div className="space-y-6">
        <div className="border border-black/5 p-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div><label className="block text-xs text-[#8C8C8C] mb-1">Title (PL)</label><input type="text" value={seoSettings.title_pl} onChange={(e) => setSeoSettings({ ...seoSettings, title_pl: e.target.value })} className="w-full p-2 border border-black/10 text-sm" /><span className="text-[10px] text-[#8C8C8C]">{seoSettings.title_pl?.length || 0}/60</span></div>
            <div><label className="block text-xs text-[#8C8C8C] mb-1">Title (EN)</label><input type="text" value={seoSettings.title_en} onChange={(e) => setSeoSettings({ ...seoSettings, title_en: e.target.value })} className="w-full p-2 border border-black/10 text-sm" /><span className="text-[10px] text-[#8C8C8C]">{seoSettings.title_en?.length || 0}/60</span></div>
          </div>
        </div>
        <div className="border border-black/5 p-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div><label className="block text-xs text-[#8C8C8C] mb-1">Description (PL)</label><textarea value={seoSettings.description_pl} onChange={(e) => setSeoSettings({ ...seoSettings, description_pl: e.target.value })} className="w-full p-2 border border-black/10 text-sm h-20" /><span className="text-[10px] text-[#8C8C8C]">{seoSettings.description_pl?.length || 0}/160</span></div>
            <div><label className="block text-xs text-[#8C8C8C] mb-1">Description (EN)</label><textarea value={seoSettings.description_en} onChange={(e) => setSeoSettings({ ...seoSettings, description_en: e.target.value })} className="w-full p-2 border border-black/10 text-sm h-20" /><span className="text-[10px] text-[#8C8C8C]">{seoSettings.description_en?.length || 0}/160</span></div>
          </div>
        </div>
        <div className="border border-black/5 p-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div><label className="block text-xs text-[#8C8C8C] mb-1">Keywords (PL)</label><textarea value={seoSettings.keywords_pl} onChange={(e) => setSeoSettings({ ...seoSettings, keywords_pl: e.target.value })} className="w-full p-2 border border-black/10 text-sm h-16" /></div>
            <div><label className="block text-xs text-[#8C8C8C] mb-1">Keywords (EN)</label><textarea value={seoSettings.keywords_en} onChange={(e) => setSeoSettings({ ...seoSettings, keywords_en: e.target.value })} className="w-full p-2 border border-black/10 text-sm h-16" /></div>
          </div>
        </div>
        <div className="border border-black/5 p-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input type="url" value={seoSettings.canonical_url} onChange={(e) => setSeoSettings({ ...seoSettings, canonical_url: e.target.value })} className="w-full p-2 border border-black/10 text-sm" placeholder="https://wm-sauna.pl" />
