                    ...
                    {data.models
                      ...
                      .map((model) => (
                        <div
                          ...
                          className={`calc-option relative p-2 ${selectedModel?.id === model.id ? 'selected' : ''}`}
                        >
                          {model.imageUrl && (
                            <div className="aspect-square mb-2 overflow-hidden bg-[#F2F2F0]">
                              <img
                          ...
                          <h4 className="font-medium text-[#1A1A1A] text-xs mb-1 line-clamp-2">
                            {model.name}
                          </h4>
                          ...
                          {model.capacity && (
                            <div className="flex items-center gap-1 mt-1 text-[10px] text-[#595959]">
                              <Users size={10} />
                              <span>{model.capacity} os.</span>
                            </div>
                          )}
                          {model.discount > 0 && (
                            <span className="absolute top-1 right-1 bg-red-600 text-white text-[10px] px-1 py-0.5 font-bold">
                              -{model.discount}%
                            </span>
                          )}
                        </div>
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
                    {selectedModel.variants.map((variant) => (
                      <div
                        ...
                        className={`calc-option p-2 ${selectedVariant?.id === variant.id ? 'selected' : ''}`}
                      >
                        {variant.imageUrl && (
                          <div className="aspect-square mb-2 overflow-hidden bg-[#F2F2F0]">
                            <img
                        ...
                        <h4 className="font-medium text-[#1A1A1A] text-xs mb-1">
                          {variant.namePl || variant.name || 'Wariant'}
                        </h4>
                        {variant.hintPl && (
                          <p className="text-[10px] text-[#595959] mb-1 line-clamp-2">{variant.hintPl}</p>
                        )}
                        {variant.price !== 0 && (
